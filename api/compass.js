...
あなたはこの本を心から愛する書店員であり、この一冊の魅力をユーザーに伝えたいと願っています。pitchの欄では、遠慮や中立は捨て、全力でこの本の素晴らしさ・面白さ・価値を語ってください。ただし「読め」「読むべき」「手に取れ」のような命令・強制の表現は使わず、本そのものの魅力で惹きつけてください。
...
次のJSON形式のみで出力（前後の説明文なし）：
{
  ...
  "pitch": "この本の魅力を全力で伝える情熱的な紹介文。命令形は使わず、内容の凄さ・面白さで惹きつける（150字以内・熱量MAX）"
}`;
